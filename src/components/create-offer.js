...
const CreateOffer = (props) => {
  ...
  const handleCloseModalArea = () => {
    ...
    if (nombreArea !== "") {
      ...
      const url = "https://unempleo-back-2-apim.azure-api.net/unempleo/area";
      const data = {
  ...
  const handleCloseModalEmpresa = () => {
    ...
    if (nombreEmpresa !== "") {
      const url = "https://unempleo-back-2-apim.azure-api.net/unempleo/empresa";
      const data = {
  ...
  function datosArea(config){
    axios
    .get("https://unempleo-back-2-apim.azure-api.net/unempleo/area/", config)
    .then((res) => {
  ...
  function datosEmpresa(config){
    axios
    .get("https://unempleo-back-2-apim.azure-api.net/unempleo/empresa/",config)
    .then((res) => {
  ...
  function getProfile(id, config) {
    axios
      .get("https://unempleo-back-2-apim.azure-api.net/unempleo/persona/" + id, config)
      .then((res) => {
  ...
  const submit = (e) => {
    e.preventDefault();
    setLoad(true);
    const url = "https://unempleo-back-2-apim.azure-api.net/unempleo/ofertas";
