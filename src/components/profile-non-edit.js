...
const ProfileNonEdit = (props) => {
  ...
  function getProfile(id) {
    ...
    axios
      .get("https://unempleo-back.azurewebsites.net/unempleo/persona/filtrarUsuario/" + id, config)
      .then((res) => {
        ...
        dataProfile = res.data
          ...
          axios.get("https://unempleo-back.azurewebsites.net/unempleo/usuarios/"+ id, config)
          .then((res) => {
